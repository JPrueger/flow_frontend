  ...
  <div class="bg-white w-4/5">
    ...
    <div class="mb-5 terms">
      ...
      <p>
        ...
        shall manage your use of our website, flow accessible at
        www.flow-projects.at.
      </p>
      <p>
        ...
        <a href="https://www.termsandcondiitionssample.com"
          >Terms And Conditiions Sample</a
        >
        and the
    ...
    <div class="mb-5">
      ...
      <p>
        Other than the content you own, under these Terms, flow and/or its
    ...
    <div class="mb-5">
      ...
      <ul class="text-left mb-5 font-normal list-disc list-inside">
      ...
      <p>
        ...
        and Flow may further restrict access by you to any areas of this
    ...
    <div class="mb-5">
      ...
      <p>
        ...
        display on this Website. By displaying Your Content, you grant Flow a
      ...
      <p>
        ...
        rights. Flow reserves the right to remove any of Your Content from this
    ...
    <div class="mb-5">
      ...
      <p>
        This Website is provided "as is," with all faults, and Flow express no
    ...
    <div class="mb-5">
      ...
      <p>
        In no event shall Flow, nor any of its officers, directors and
        ...
        under contract. Flow, including its officers, directors and employees
    ...
    <div class="mb-5">
      ...
      <p>
        You hereby indemnify to the fullest extent Flow from and against any
    ...
    <div class="mb-5">
      ...
      <p>
        Flow is permitted to revise these Terms at any time as it sees fit, and
    ...
    <div class="mb-5">
      ...
      <p>
        The Flow is allowed to assign, transfer, and subcontract its rights
    ...
    <div class="mb-5">
      ...
      <p>
        These Terms constitute the entire agreement between Flow and you in
    ...
    <div class="mb-5">
      ...
      <p>
        ...
        laws of the State of at, and you submit to the non-exclusive
        jurisdiction of the state and federal courts located in at for the
