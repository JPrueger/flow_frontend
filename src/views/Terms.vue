<template>
  <div>
    ...
    <div class="w-2/3 mb-5">
      ...
      <p>These Terms will be applied fully and affect to your use of this Website. By using this Website, you agreed to
        ...
        Website Standard Terms and Conditions. These Terms and Conditions have been generated with the help of the <a
            href="https://www.termsandcondiitionssample.com">Terms And Conditiions Sample</a> and the <a
    ...
    <div class="w-2/3 mb-5">
      ...
      <p>Certain areas of this Website are restricted from being access by you and Flow may further restrict access by
    ...
    <div class="w-2/3 mb-5">
      ...
      <p>In these Website Standard Terms and Conditions, "Your Content" shall mean any audio, video text, images or
        other material you choose to display on this Website. By displaying Your Content, you grant Flow a
      ...
      <p>Your Content must be your own and must not be invading any third-party’s rights. Flow reserves the right to
    ...
    <div class="w-2/3 mb-5">
      ...
      <p>In no event shall Flow, nor any of its officers, directors and employees, shall be held liable for anything
        arising out of or in any way connected with your use of this Website whether such liability is under contract. Flow, including its officers, directors and employees shall not be held liable for any indirect, consequential
